...
class EngineArgs:
    ...
    effective_sjf_max_wait_ms: int = SchedulerConfig.effective_sjf_max_wait_ms
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        scheduler_group.add_argument(
            ...
            **scheduler_kwargs["effective_sjf_max_wait_ms"],
        )
        scheduler_group.add_argument(
    ...
    def create_engine_config(
        ...
        scheduler_config = SchedulerConfig(
            ...
            effective_sjf_max_wait_ms=self.effective_sjf_max_wait_ms,
